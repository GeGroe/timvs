...
\paragraph{I.2 \& I.3 Von NI ausgehend gegen VN und User.}
\label{parag:vonNI}
...
%Dass VMs, die z.B. als Testumgebungen eingesetzt werden, häufig deaktiviert bzw. offline sind, erschwert das systemweite Patchmanagement. 
%Würmer infizieren meist relativ schnell alle verwundbaren Systeme. Geht die VM danach offline wird Malware darin nicht entfernt und die Wurminfektionselle startet erneut beim Onlinegehen der VM.
