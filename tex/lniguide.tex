...
Jene basieren maßgeblich auf Isolationverletzungen bei Nutzung gemeinsamer Ressourcen. Mit den in den Kapiteln \ref{subsec:ansatz1} und \ref{subsec:ansatz2} vorgestellten Ansätzen konnten zwei VNE-Algorithmus dargestellt werden, die im Stande sind solche Risiken über Zuordnung von Knotenleveln zu reduzieren.\\
